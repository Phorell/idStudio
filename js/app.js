(() => {
    ...
    function initSliders() {
        if (document.querySelector(".people__slider")) new swiper_core_Swiper(".people__slider", {
    ...
    da.init();
    let menuArrows = document.querySelectorAll("._icon-arrow");
    ...
    let navTitle = document.querySelectorAll(".portfolio__nav-title");
    if (navTitle.length > 0) for (let index = 0; index < navTitle.length; index++) {
        ...
        menuNav.addEventListener("click", (function(event) {
            document.querySelectorAll(".portfolio__nav-title").forEach((item => {
                item.classList.remove("_tab-active");
            }));
            event.isClick = true;
            menuNav.classList.add("_tab-active");
        }));
    }
    const list = document.querySelector(".portfolio__navigation"), items = document.querySelectorAll(".portfolio__item");
    function filter() {
